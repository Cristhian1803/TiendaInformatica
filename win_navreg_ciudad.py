...
querysql_update = "update ciudad set idciudad = {}, nomCiudad = '{}' where idciudad = {}"
querysql_insert = "insert into ciudad (idCiudad, nomCiudad) values ({}, '{}')"
querysql_delete = "delete from ciudad where idciudad = {}"
querysql_select = "select idciudad, nomciudad from ciudad order by idciudad"
querysql_selectmax = "select ifnull(max(idciudad), 0) + 1 from ciudad"
#querysql_selectmax = None --- Habilitar si no se necesita el autoincrementable de arriba
etiquetascol = ["Código", "Ciudad"]
...
class iniciar:
    def __init__(self, conexion, listaapegar = None):
        ...
        self.vnav = uic.loadUi("win_navreg_ciudad.ui")
    ...
    def cargarventanaedicion(self):
        ...
        try:
            ...
            if self.permiso == (1,):
                self.vedit = uic.loadUi("win_edicion_ciudad.ui")
    ...
    def click_actionImprimir(self):
        if self.cantfilas > 0:
            ...
            filename = "ciudad {}.pdf".format(str(vvfecha)) #Nombre del archivo
