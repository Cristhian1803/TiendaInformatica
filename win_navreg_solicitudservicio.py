...
v_titulo = "Solicitud de Servicio"
...
querysql_delete = "delete from solicitudservicio where idsolicitud = {}"
querysql_delete2 = "delete from detsolicservicio where idsolicitud = {}"
...
"""
querysql_selectmax = "select ifnull(max(idSolicitud), 0) + 1 from solicitudservicio"
#querysql_selectmax = None --- Habilitar si no se necesita el autoincrementable de arriba



etiquetascol = ["idSolicitud", "idCliente", "Razón Social", "RUC-CI", "Valido Desde", "Valido Hasta", "idUsuario", "Usuario"]
...
class iniciar:
    def __init__(self, conexion, listaapegar = None):
        ...
        self.vnav = uic.loadUi("win_navreg_solicitudservicio.ui")
    ...
    def cargarventanaedicion(self):
        ...
        try:
            ...
            if self.permiso == (1,):
                self.vedit = uic.loadUi("win_edicion_solicitudservicio.ui")
                self.vedit.label.setText(etiquetascol[0] + ": ")
                self.vedit.label_3.setText("Cliente: ")
                self.vedit.label_5.setText("Valido Desde: ")
                self.vedit.label_4.setText("Valido Hasta: ")
            ...
            vfecha2 = QtCore.QDate.currentDate()
            self.vedit.dateEdit.setDate(vfecha)
            self.vedit.dateEdit_2.setDate(vfecha2) #fecha
    ...
    def clicked_pushButton_8(self): #Busca items para el det SERVICIO
        import win_navreg_items
        self.listalineedit_pks_items = [self.vedit.lineEdit_12, self.vedit.lineEdit_22, self.vedit.lineEdit_13, self.vedit.lineEdit_4, self.vedit.lineEdit_20]
    ...
    def click_actionaceptar(self):
        ...
        vfecha2 = self.vedit.dateEdit_2.dateTime().toString("yyyy-MM-dd")
       ...
       # v25 = self.vedit.lineEdit_6.text() #TipoCobro
        ...
        if len(v0) > 0 and len(v1) > 0 and len(v23) > 0:
            if v0.isnumeric():
                    ...
                    celda5 = QtWidgets.QTableWidgetItem(vfecha2)
                    ...
                    try:
                        ...
                        if self.editando: #Modificando
                            ...
                            cursor.execute(querysql_insert.format(v0, v1, vfecha, vfecha2, v13)) #SQL ejecutandose NUEVO 
                        ...
                        if self.cantfilas > 0:
                            ...
                            filename = "Solicitud de Servicio fact {}.pdf".format(str(vvfecha)) #Nombre del archivo
