...
v_titulo = "Nota de Débito de Venta"
...
select
    ...
    nc.Fecha,
    nc.idUsuarios, 
    us.usuario from notadebitoventa nc
...
"""
querysql_selectmax = "select ifnull(max(idNotaDebVenta), 0) + 1 from notadebitoventa"
...
class iniciar:
    def __init__(self, conexion, listaapegar = None):
        ...
        self.vnav = uic.loadUi("win_navreg_notadebitoventas.ui")
    ...
    def cargarventanaedicion(self):
        ...
        try:
            ...
            if self.permiso == (1,):
                self.vedit = uic.loadUi("win_edicion_notadebitoventas.ui")
            ...
            if v0.isnumeric():
                    ...
                    try:
                        ...
                        if self.cantfilas > 0:
                            ...
                            filename = "Nota Debito Venta {}.pdf".format(str(vvfecha)) #Nombre del archivo
