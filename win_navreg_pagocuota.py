...
select 
    ...
    cc.fechaCaducidad
    from pagocuota cc
    inner join cuentaspagar cpa on cc.NroCuenta = cpa.NroCuenta 
...
etiquetascol = ["idCuota", "Nro de Cuenta", "Nro de Factura", "idProveedor", "Razon Social", "RUC-CI", "Nro de Cuotas", "Fecha de Caducidad"]
...
class iniciar:
    def __init__(self, conexion, listaapegar = None):
        ...
        self.vnav = uic.loadUi("win_navreg_pagocuota.ui")
    ...
    def activated_tableWidget(self): #Se activa al darle Enter con una fila seleccionada
        if self.mylistaapegar is None:
            ...
            try:
                ...
                self.mylistaapegar[5].setText(v5) #     
                self.vnav.close()
            except:
