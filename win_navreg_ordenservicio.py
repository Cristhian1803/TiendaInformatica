...
querysql_delete = "delete from ordenservicio where idordenservicio = {}"
querysql_delete2 = "delete from detordenservicio where idordenservicio = {}"
...
select
    ...
    pr.fecha,
    pr.idUsuarios, 
    us.usuario from ordenservicio pr
        inner join clientes p on pr.idClientes = p.idClientes
        inner join usuarios us on pr.IdUsuarios = us.IdUsuarios
    order by pr.idOrdenServicio
"""
querysql_selectmax = "select ifnull(max(idOrdenServicio), 0) + 1 from ordenservicio"
#querysql_selectmax = None --- Habilitar si no se necesita el autoincrementable de arriba



etiquetascol = ["idOrdenServicio", "idCliente", "Razón Social", "RUC-CI", "Fecha", "idUsuario", "Usuario"]
...
class iniciar:
    def __init__(self, conexion, listaapegar = None):
        ...
        self.vnav = uic.loadUi("win_navreg_ordenservicio.ui")
    ...
    def cargarventanaedicion(self):
        ...
        try:
            ...
            if self.permiso == (1,):
                self.vedit = uic.loadUi("win_edicion_ordenservicio.ui")
            ...
            if v0.isnumeric():
                    ...
                    try:
                        ...
                        if self.editando: #Modificando
                            ...
                            cursor.execute(querysql_insert.format(v0, v1, vfecha, v13)) #SQL ejecutandose NUEVO 
                        ...
                        self.vnav.tableWidget.setItem(vfila, 5, celda13)
                        self.vnav.tableWidget.setItem(vfila, 6, celda14)#
    ...
    def cargardatos(self):
        ...
        for campoid, campodescrip, campo3, campo4, campo5, campo6, campo7 in cursor: #
