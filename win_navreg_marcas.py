...
querysql_update = "update marcas set idmarcas = {}, NombreMarca = '{}' where idmarcas = {}"
querysql_insert = "insert into marcas (idmarcas, NombreMarca) values ({}, '{}')"
querysql_delete = "delete from marcas where idmarcas = {}"
querysql_select = "select idmarcas, NombreMarca from marcas order by idmarcas"
querysql_selectmax = "select ifnull(max(idmarcas), 0) + 1 from marcas"
#querysql_selectmax = None --- Habilitar si no se necesita el autoincrementable de arriba
etiquetascol = ["Código", "Marca"]
...
class iniciar:
    def __init__(self, conexion, listaapegar = None):
        ...
        self.vnav = uic.loadUi("win_navreg_marcas.ui")
    ...
    def cargarventanaedicion(self):
        ...
        try:
            ...
            if self.permiso == (1,):
                self.vedit = uic.loadUi("win_edicion_marcas.ui")
    ...
    def click_actionImprimir(self):
        if self.cantfilas > 0:
            ...
            filename = "marcas {}.pdf".format(str(vvfecha)) #Nombre del archivo
