...
querysql_update = "update cargo set idcargo = {}, descrip = '{}', salario = {} where idcargo = {}"
querysql_insert = "insert into cargo (idcargo, descrip, salario) values ({}, '{}', {})"
querysql_delete = "delete from cargo where idcargo = {}"
querysql_select = "select idcargo, descrip, salario from cargo"
querysql_selectmax = "select ifnull(max(idcargo), 0) + 1 from cargo"
#querysql_selectmax = None --- Habilitar si no se necesita el autoincrementable de arriba
etiquetascol = ["Código", "Descripcion", "Salario"]
...
class iniciar:
    def __init__(self, conexion, listaapegar = None):
        ...
        self.vnav = uic.loadUi("win_navreg_cargos.ui")
    ...
    def cargarventanaedicion(self):
        ...
        try:
            ...
            if self.permiso == (1,):
                self.vedit = uic.loadUi("win_edicion_cargos.ui")
                self.vedit.label_3.setText(etiquetascol[0] + ": ")
                self.vedit.label_4.setText(etiquetascol[1] + ": ")
                self.vedit.label_7.setText(etiquetascol[2] + ": ")

                self.vedit.lineEdit_2.setMaxLength(45)
                self.vedit.lineEdit_6.setMaxLength(15)
            else:
            ...
            self.vedit.lineEdit_6.setText(v2)#
    ...
    def click_actionImprimir(self):
        if self.cantfilas > 0:
            ...
            filename = "cargo {}.pdf".format(str(vvfecha)) #Nombre del archivo
