...
querysql_update = "update clientes set idclientes = {}, RazonSocial = '{}', RUC_CI = '{}', Direccion = nullif(trim('{}'),''), TelefCel = nullif(trim('{}'),''), ClienteInterno = {} where idclientes = {}"
querysql_insert = "insert into clientes (idclientes, RazonSocial, RUC_CI, Direccion, TelefCel, ClienteInterno) values ({}, '{}', '{}', nullif(trim('{}'),''), nullif(trim('{}'),''), {})"
querysql_delete = "delete from clientes where idclientes = {}"
querysql_select = "select idclientes, RazonSocial, RUC_CI, Direccion, TelefCel, ClienteInterno from clientes order by idclientes"
querysql_selectmax = "select ifnull(max(idclientes), 0) + 1 from clientes"
#querysql_selectmax = None --- Habilitar si no se necesita el autoincrementable de arriba
etiquetascol = ["Código", "Razón Social", "RUC CI", "Dirección", "Teléfono", "Cliente Interno"]
...
class iniciar:
    def __init__(self, conexion, listaapegar = None):
        ...
        self.vnav = uic.loadUi("win_navreg_clientes.ui")
    ...
    def cargarventanaedicion(self):
        ...
        try:
            ...
            if self.permiso == (1,):
                self.vedit = uic.loadUi("win_edicion_clientes.ui")
                ...
                self.vedit.label_8.setText(etiquetascol[5] + ": ")
    ...
    def click_actionaceptar(self):
        ...
        if len(v0) > 0 and len(v1) > 0 and len(v2) > 0:
            ...
            try:
                ...
                if self.editando: #Modificando
                    ...
                    cursor.execute(querysql_insert.format(v0, v1, v2, v3, v4, vchk6)) #SQL ejecutandose NUEVO 
    ...
    def click_actionImprimir(self):
        if self.cantfilas > 0:
            ...
            filename = "clientes {}.pdf".format(str(vvfecha)) #Nombre del archivo
    ...
    def cargardatos(self):
        ...
        for campoid, campodescrip, campo3, campo4, campo5, campo7 in cursor: #
