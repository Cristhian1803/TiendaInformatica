...
class iniciar:
    ...
    def activated_tableWidget(self): #Se activa al darle Enter con una fila seleccionada
        if self.mylistaapegar is None:
            ...
            try:
                print ("Pegar")
                v0 = self.vnav.tableWidget.selectedIndexes()[3].data()
                v1 = self.vnav.tableWidget.selectedIndexes()[5].data()
                v2 = self.vnav.tableWidget.selectedIndexes()[6].data()
                v3 = self.vnav.tableWidget.selectedIndexes()[7].data() #
    ...
    def click_actionInforme(self):
        import win_filtro_ventas
        self.run_win_filtro_ventas = win_filtro_ventas.iniciar(self.conex)
